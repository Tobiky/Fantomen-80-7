...
namespace Basic_Pathfinder
{
    ...
    public class Game1 : Game
    {
        ...
        public Game1()
        {
            ...
            graphics.PreferredBackBufferWidth = size*2;
            MapData.Screen = new Rectangle(0, 0, size*2, size);
        }
        ...
        private void GenerateWorld()
        {
            ...
            int tempInt = Window.ClientBounds.Bottom / new Random().Next(1, Window.ClientBounds.Bottom / new Random().Next(1, 1000));
            ...
            for (int i = 0; i < tempInt; i++)
            {
                ...
                {
                    r = new Rectangle(p, new Point(17,17));
                ...
                else
                {
                    ...
                    if (MapData.Obstacles.Any(obs => obs.Intersects(r)) || r.Contains(p))
                    {
                        i--;
                        continue;
                    }
        ...
        protected override void Initialize()
        {
            ...
            MapData.Goal = placement(size*2/6-1, size/6-1); //3 4
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                int pfG = GC.GetGeneration(pf);
                int obG = GC.GetGeneration(MapData.Obstacles);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            foreach (var node in pf.OpenLLGN)
                spriteBatch.Draw(defaultTexture, new Rectangle(node.Location.Cordinates, new Point(5, 5)), Color.Gray);
            foreach (var node in pf.ClosedLLGN)
                spriteBatch.Draw(defaultTexture, new Rectangle(node.Location.Cordinates, new Point(5, 5)), Color.LightGray);

            LinkedList<GridNode> path = Path(pfPath);
            foreach (var node in path)
                spriteBatch.Draw(defaultTexture, new Rectangle(node.Location.Cordinates, new Point(5, 5)), Color.White);
